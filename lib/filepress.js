    ...
    start: sourceFolder => {
        ...
        walk(sourceFolder, (error, file) => {
            ...
            Promise.all(files
                ...
                //TODO this needs a new solution now as asynchronous.
                .map(file => addMarkdown(file)))
                .then(values => transformsToUser.forEach(transform => values = transform(values, settings)))
